  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background to-muted/20">
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-16">
        <Card className="w-full max-w-md border border-border/50 shadow-lg backdrop-blur-sm bg-card/90 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="grid grid-cols-1 md:grid-cols-5 h-full">
            {/* Image Column - Takes 2/5 of the space */}
            <div className="hidden md:flex md:col-span-2 items-center justify-center p-4 bg-muted/10">
              <img 
