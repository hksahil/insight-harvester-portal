  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background to-muted/20">
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-4xl fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <Card className="border border-border/50 shadow-lg backdrop-blur-sm bg-card/90 overflow-hidden">
